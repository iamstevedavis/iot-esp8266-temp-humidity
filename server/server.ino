...
/**
 * Includes for Secure HTTP Updater
 */
...
/**
 * Config to communicate with sensor
...
/**
 * Global Constants for Secure HTTP Updater
 */
#define host "esp8266-webupdate"
...
/**
 * Declarations for Secure HTTP Updater
 */
...
long lastMsg = 0;
long MQTTReconnectDelay = 120000;
long sensorReadDelay = 120000;
...
void setup() {
  ...
  setup_secure_updater();
}

/**
 * This is the setup function for the Secure HTTP Updater
 */
void setup_secure_updater() {
  delay(20);
  ...
  Serial.println("HTTPS Update Server ready!");
...
/**
 * This can be used to consume MQTT messages
 */
...
void loop() {
  ...
  long now = millis();
  if (now - lastMsg > sensorReadDelay) {
    lastMsg = now;
